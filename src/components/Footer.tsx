      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          <div className="space-y-5 md:col-span-1">
            ...
            <p className="inline-flex rounded-full border border-lime-200/40 bg-white/10 px-3 py-1 text-xs font-bold uppercase text-lime-200">
              Consulta social por R$40
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-emerald-50/75">
              ...
              <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-lime-200" /> (21) 98168-2922</li>
              <li className="flex items-center gap-2"><MapPin className="h-4 w-4 text-lime-200" /> Nova Iguaçu, RJ</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-6 text-sm text-emerald-50/60">
          ...
          <p>Consultas iniciadas pela plataforma têm valor social de R$40.</p>
        </div>
      </div>
    </footer>
  );
